...
<div class="wrap">
  ...
  <div class="body">
    <p class="greeting">Hola, <?php echo e($nombreUsuario); ?></p>
    ...
    <div class="info-box">
      <div class="info-row">
        ...
        <span class="value"><?php echo e($nombreUsuario); ?></span>
      </div>
      <div class="info-row">
        <span class="label">📧 Correo</span>
        <span class="value"><?php echo e($correoUsuario); ?></span>
      </div>
      <div class="info-row">
        <span class="label">📅 Fecha y hora</span>
        <span class="value"><?php echo e($fechaHora); ?></span>
      </div>
    </div>

    <div class="btn-block">
      <a href="<?php echo e($urlSistema); ?>" class="btn">Ir al sistema →</a>
    </div>
  ...
  <div class="footer">
    © <?php echo e(date('Y')); ?> Sistema de Reportes · Este es un correo automático, no responder.
  </div>
</div>
</body>
</html>
<?php /**PATH /Users/josearriaga/Laravel/sistemaReportes/resources/views/emails/login-notificacion.blade.php ENDPATH**/ ?>